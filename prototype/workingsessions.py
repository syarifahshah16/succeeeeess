...
class mainNetAnalysis(wx.Frame):
      def __init__(self, *args, **kwds):
            ...
            self.pcaplist = wx.dataview.DataViewListCtrl(self.packet_details_copy_pane_2, wx.ID_ANY)
            """wx.ListCtrl(self.packet_details_copy_pane_2, wx.ID_ANY, style=wx.LC_HRULES | wx.LC_REPORT | wx.LC_SINGLE_SEL | wx.LC_VRULES)"""
            ...
            self.dnslist = wx.dataview.DataViewListCtrl(self.packet_details_copy_Protocol, wx.ID_ANY)
            """wx.ListCtrl(self.packet_details_copy_Protocol, wx.ID_ANY, style=wx.LC_HRULES | wx.LC_REPORT | wx.LC_SINGLE_SEL | wx.LC_VRULES)"""
      ...
      def __set_properties(self):
            ...
            self.SetTitle("Network Analysis (TCPDUMP)")
            ...
            self.pcaplist.SetMinSize((1920, 370))
            self.packetsList.SetMinSize((1920, 370))
    ...
    # First try ipv4 and then ipv6
      ...
      def on_menu_upload_PCAP(self, event):  # wxGlade: MyFrame.<event_handler>
            ...
            if openFileDialog.ShowModal() == wx.ID_OK:
                  ...
                  for timestamp, buf in pcap:
                    ...
                    row = [str(Packet), str(datetime.datetime.utcfromtimestamp(timestamp)), str(src_ip), str(dst_ip), str(repr(request))]
      ...
      def on_tools_clear(self, event):  # wxGlade: mainNetAnalysis.<event_handler>
            self.pcaplist.DeleteAllItems()
            self.dnslist.DeleteAllItems()
